...
__global__  __launch_bounds__(128) void ft_sgemm_wide(int M, int N, int K, float *A, float *B, float *C, float alpha, float beta){
    // ms = 128, ns = 32, ks = 8
    // mw = 64, nw = 16
    // mr = 8, nr = 4
    // blockId, warpId, and threadIdx
    
    int ms = 32, ns = 128, ks = 8, mw = 16, nw = 64, mr = 4, nr = 8;
    ...
    float2 prefetch_vector_tile_A[1];
    float4 prefetch_vector_tile_B[2];
    prefetch_vector_tile_A[0] = *((float2*)A + 0);
    ...
    *(((float2*)buffer_A) + 1 * tx + 0) = prefetch_vector_tile_A[0];
    ...
    *(((float4*)buffer_B) + 2 * tx + 1) = prefetch_vector_tile_B[1];
    ...
    // ABFT
    float2 block_level_A_c[1];
    float4 block_level_B_r[2];
    float A_c = 0., B_r = 0.;
    
    A_c += prefetch_vector_tile_A[0].x; A_c += prefetch_vector_tile_A[0].y; 
    ...
    *(((float2*)checksum_buffer_A) + tx * 1 + 0) = block_level_A_c[0];
    ...
    *(((float4*)checksum_buffer_B) + tx * 2 + 1) = block_level_B_r[1];
    ...
    for(k = 0; k < K; k += ks){
        ...
        for(kk = 0; kk < ks; ++kk){
            ...
            res[0 ] += vec_A[offset_register_kk * 1 + 0].x * vec_B[offset_register_kk * 2 + 0].x;
            res[1 ] += vec_A[offset_register_kk * 1 + 0].x * vec_B[offset_register_kk * 2 + 0].y;
            res[2 ] += vec_A[offset_register_kk * 1 + 0].x * vec_B[offset_register_kk * 2 + 0].z;
            res[3 ] += vec_A[offset_register_kk * 1 + 0].x * vec_B[offset_register_kk * 2 + 0].w;
            
            res[4 ] += vec_A[offset_register_kk * 1 + 0].x * vec_B[offset_register_kk * 2 + 1].x;
            res[5 ] += vec_A[offset_register_kk * 1 + 0].x * vec_B[offset_register_kk * 2 + 1].y;
            res[6 ] += vec_A[offset_register_kk * 1 + 0].x * vec_B[offset_register_kk * 2 + 1].z;
            res[7 ] += vec_A[offset_register_kk * 1 + 0].x * vec_B[offset_register_kk * 2 + 1].w;
            
            res[8 ] += vec_A[offset_register_kk * 1 + 0].y * vec_B[offset_register_kk * 2 + 0].x;
            res[9 ] += vec_A[offset_register_kk * 1 + 0].y * vec_B[offset_register_kk * 2 + 0].y;
            res[10] += vec_A[offset_register_kk * 1 + 0].y * vec_B[offset_register_kk * 2 + 0].z;
            res[11] += vec_A[offset_register_kk * 1 + 0].y * vec_B[offset_register_kk * 2 + 0].w;
            
            res[12] += vec_A[offset_register_kk * 1 + 0].y * vec_B[offset_register_kk * 2 + 1].x;
            res[13] += vec_A[offset_register_kk * 1 + 0].y * vec_B[offset_register_kk * 2 + 1].y;
            res[14] += vec_A[offset_register_kk * 1 + 0].y * vec_B[offset_register_kk * 2 + 1].z;
            res[15] += vec_A[offset_register_kk * 1 + 0].y * vec_B[offset_register_kk * 2 + 1].w;
            
            res[16] += vec_A[offset_register_kk * 1 + 0].z * vec_B[offset_register_kk * 2 + 0].x;
            res[17] += vec_A[offset_register_kk * 1 + 0].z * vec_B[offset_register_kk * 2 + 0].y;
            res[18] += vec_A[offset_register_kk * 1 + 0].z * vec_B[offset_register_kk * 2 + 0].z;
            res[19] += vec_A[offset_register_kk * 1 + 0].z * vec_B[offset_register_kk * 2 + 0].w;
            
            res[20] += vec_A[offset_register_kk * 1 + 0].z * vec_B[offset_register_kk * 2 + 1].x;
            res[21] += vec_A[offset_register_kk * 1 + 0].z * vec_B[offset_register_kk * 2 + 1].y;
            res[22] += vec_A[offset_register_kk * 1 + 0].z * vec_B[offset_register_kk * 2 + 1].z;
            res[23] += vec_A[offset_register_kk * 1 + 0].z * vec_B[offset_register_kk * 2 + 1].w;
            
            res[24] += vec_A[offset_register_kk * 1 + 0].w * vec_B[offset_register_kk * 2 + 0].x;
            res[25] += vec_A[offset_register_kk * 1 + 0].w * vec_B[offset_register_kk * 2 + 0].y;
            res[26] += vec_A[offset_register_kk * 1 + 0].w * vec_B[offset_register_kk * 2 + 0].z;
            res[27] += vec_A[offset_register_kk * 1 + 0].w * vec_B[offset_register_kk * 2 + 0].w;
            
            res[28] += vec_A[offset_register_kk * 1 + 0].w * vec_B[offset_register_kk * 2 + 1].x;
            res[29] += vec_A[offset_register_kk * 1 + 0].w * vec_B[offset_register_kk * 2 + 1].y;
            res[30] += vec_A[offset_register_kk * 1 + 0].w * vec_B[offset_register_kk * 2 + 1].z;
            res[31] += vec_A[offset_register_kk * 1 + 0].w * vec_B[offset_register_kk * 2 + 1].w;
        ...
        if(((k+8) %(int(K / 20))) == 0){
            ...
            C_c[0 ] = res[0 ]; C_c[0 ] += res[8 ]; C_c[0 ] += res[16]; C_c[0 ] += res[24]; 
            C_c[1 ] = res[1 ]; C_c[1 ] += res[9 ]; C_c[1 ] += res[17]; C_c[1 ] += res[25]; 
            C_c[2 ] = res[2 ]; C_c[2 ] += res[10]; C_c[2 ] += res[18]; C_c[2 ] += res[26]; 
            C_c[3 ] = res[3 ]; C_c[3 ] += res[11]; C_c[3 ] += res[19]; C_c[3 ] += res[27]; 
            C_c[4 ] = res[4 ]; C_c[4 ] += res[12]; C_c[4 ] += res[20]; C_c[4 ] += res[28]; 
            C_c[5 ] = res[5 ]; C_c[5 ] += res[13]; C_c[5 ] += res[21]; C_c[5 ] += res[29]; 
            C_c[6 ] = res[6 ]; C_c[6 ] += res[14]; C_c[6 ] += res[22]; C_c[6 ] += res[30]; 
            C_c[7 ] = res[7 ]; C_c[7 ] += res[15]; C_c[7 ] += res[23]; C_c[7 ] += res[31]; 
        ...
        *(s + (3 * 16)) = C_r[3];
        ...
        if (tx < int(1 * blockDim.x / 2)){
            r_ = *((float4*)((float*)sAB + ((tx& 15) * 2 + 0 ) * 16 + 0));
            checksum_[0] -= r_.x;
            checksum_[0] -= r_.y;
            checksum_[0] -= r_.z;
            checksum_[0] -= r_.w;
            r_ = *((float4*)((float*)sAB + ((tx& 15) * 2 + 0 ) * 16 + 4));
            checksum_[0] -= r_.x;
            checksum_[0] -= r_.y;
            checksum_[0] -= r_.z;
            checksum_[0] -= r_.w;
            r_ = *((float4*)((float*)sAB + ((tx& 15) * 2 + 0 ) * 16 + 8));
            checksum_[0] -= r_.x;
            checksum_[0] -= r_.y;
            checksum_[0] -= r_.z;
            checksum_[0] -= r_.w;
            r_ = *((float4*)((float*)sAB + ((tx& 15) * 2 + 0 ) * 16 + 12));
            checksum_[0] -= r_.x;
            checksum_[0] -= r_.y;
            checksum_[0] -= r_.z;
            checksum_[0] -= r_.w;
            r_ = *((float4*)((float*)sAB + ((tx& 15) * 2 + 1 ) * 16 + 0));
            checksum_[1] -= r_.x;
            checksum_[1] -= r_.y;
            checksum_[1] -= r_.z;
            checksum_[1] -= r_.w;
            r_ = *((float4*)((float*)sAB + ((tx& 15) * 2 + 1 ) * 16 + 4));
            checksum_[1] -= r_.x;
            checksum_[1] -= r_.y;
            checksum_[1] -= r_.z;
            checksum_[1] -= r_.w;
            r_ = *((float4*)((float*)sAB + ((tx& 15) * 2 + 1 ) * 16 + 8));
            checksum_[1] -= r_.x;
            checksum_[1] -= r_.y;
            checksum_[1] -= r_.z;
            checksum_[1] -= r_.w;
            r_ = *((float4*)((float*)sAB + ((tx& 15) * 2 + 1 ) * 16 + 12));
            checksum_[1] -= r_.x;
            checksum_[1] -= r_.y;
            checksum_[1] -= r_.z;
            checksum_[1] -= r_.w;
            ...
            r_ = *((float4*)((float*)sAB + 512 + ((tx & 63) * 2 + 0) * 8 + 0));
            checksum_[0] -= r_.x;
            checksum_[0] -= r_.y;
            checksum_[0] -= r_.z;
            checksum_[0] -= r_.w;
            r_ = *((float4*)((float*)sAB + 512 + ((tx & 63) * 2 + 0) * 8 + 4));
            checksum_[0] -= r_.x;
            checksum_[0] -= r_.y;
            checksum_[0] -= r_.z;
            checksum_[0] -= r_.w;
            r_ = *((float4*)((float*)sAB + 512 + ((tx & 63) * 2 + 1) * 8 + 0));
            checksum_[1] -= r_.x;
            checksum_[1] -= r_.y;
            checksum_[1] -= r_.z;
            checksum_[1] -= r_.w;
            r_ = *((float4*)((float*)sAB + 512 + ((tx & 63) * 2 + 1) * 8 + 4));
            checksum_[1] -= r_.x;
            checksum_[1] -= r_.y;
            checksum_[1] -= r_.z;
            checksum_[1] -= r_.w;
        ...
        *((float*)sAB + (1 - int(tx / int(blockDim.x / 2))) * ns + (tx % (int(ws / 2))) * 2 + 1) = checksum_[1];
        ...
        res[0] += int( (fabsf(*((float*)tmp_row + 0)) > err_bound1) && (fabsf(*((float*)tmp_col + 0)) > err_bound1)) * (*((float*)tmp_col + 0));
        res[1] += int( (fabsf(*((float*)tmp_row + 0)) > err_bound1) && (fabsf(*((float*)tmp_col + 1)) > err_bound1)) * (*((float*)tmp_col + 1));
        res[2] += int( (fabsf(*((float*)tmp_row + 0)) > err_bound1) && (fabsf(*((float*)tmp_col + 2)) > err_bound1)) * (*((float*)tmp_col + 2));
        res[3] += int( (fabsf(*((float*)tmp_row + 0)) > err_bound1) && (fabsf(*((float*)tmp_col + 3)) > err_bound1)) * (*((float*)tmp_col + 3));
        res[4] += int( (fabsf(*((float*)tmp_row + 0)) > err_bound1) && (fabsf(*((float*)tmp_col + 4)) > err_bound1)) * (*((float*)tmp_col + 4));
        res[5] += int( (fabsf(*((float*)tmp_row + 0)) > err_bound1) && (fabsf(*((float*)tmp_col + 5)) > err_bound1)) * (*((float*)tmp_col + 5));
        res[6] += int( (fabsf(*((float*)tmp_row + 0)) > err_bound1) && (fabsf(*((float*)tmp_col + 6)) > err_bound1)) * (*((float*)tmp_col + 6));
        res[7] += int( (fabsf(*((float*)tmp_row + 0)) > err_bound1) && (fabsf(*((float*)tmp_col + 7)) > err_bound1)) * (*((float*)tmp_col + 7));
        res[8] += int( (fabsf(*((float*)tmp_row + 1)) > err_bound1) && (fabsf(*((float*)tmp_col + 0)) > err_bound1)) * (*((float*)tmp_col + 0));
        res[9] += int( (fabsf(*((float*)tmp_row + 1)) > err_bound1) && (fabsf(*((float*)tmp_col + 1)) > err_bound1)) * (*((float*)tmp_col + 1));
        res[10] += int( (fabsf(*((float*)tmp_row + 1)) > err_bound1) && (fabsf(*((float*)tmp_col + 2)) > err_bound1)) * (*((float*)tmp_col + 2));
        res[11] += int( (fabsf(*((float*)tmp_row + 1)) > err_bound1) && (fabsf(*((float*)tmp_col + 3)) > err_bound1)) * (*((float*)tmp_col + 3));
        res[12] += int( (fabsf(*((float*)tmp_row + 1)) > err_bound1) && (fabsf(*((float*)tmp_col + 4)) > err_bound1)) * (*((float*)tmp_col + 4));
        res[13] += int( (fabsf(*((float*)tmp_row + 1)) > err_bound1) && (fabsf(*((float*)tmp_col + 5)) > err_bound1)) * (*((float*)tmp_col + 5));
        res[14] += int( (fabsf(*((float*)tmp_row + 1)) > err_bound1) && (fabsf(*((float*)tmp_col + 6)) > err_bound1)) * (*((float*)tmp_col + 6));
        res[15] += int( (fabsf(*((float*)tmp_row + 1)) > err_bound1) && (fabsf(*((float*)tmp_col + 7)) > err_bound1)) * (*((float*)tmp_col + 7));
        res[16] += int( (fabsf(*((float*)tmp_row + 2)) > err_bound1) && (fabsf(*((float*)tmp_col + 0)) > err_bound1)) * (*((float*)tmp_col + 0));
        res[17] += int( (fabsf(*((float*)tmp_row + 2)) > err_bound1) && (fabsf(*((float*)tmp_col + 1)) > err_bound1)) * (*((float*)tmp_col + 1));
        res[18] += int( (fabsf(*((float*)tmp_row + 2)) > err_bound1) && (fabsf(*((float*)tmp_col + 2)) > err_bound1)) * (*((float*)tmp_col + 2));
        res[19] += int( (fabsf(*((float*)tmp_row + 2)) > err_bound1) && (fabsf(*((float*)tmp_col + 3)) > err_bound1)) * (*((float*)tmp_col + 3));
        res[20] += int( (fabsf(*((float*)tmp_row + 2)) > err_bound1) && (fabsf(*((float*)tmp_col + 4)) > err_bound1)) * (*((float*)tmp_col + 4));
        res[21] += int( (fabsf(*((float*)tmp_row + 2)) > err_bound1) && (fabsf(*((float*)tmp_col + 5)) > err_bound1)) * (*((float*)tmp_col + 5));
        res[22] += int( (fabsf(*((float*)tmp_row + 2)) > err_bound1) && (fabsf(*((float*)tmp_col + 6)) > err_bound1)) * (*((float*)tmp_col + 6));
        res[23] += int( (fabsf(*((float*)tmp_row + 2)) > err_bound1) && (fabsf(*((float*)tmp_col + 7)) > err_bound1)) * (*((float*)tmp_col + 7));
        res[24] += int( (fabsf(*((float*)tmp_row + 3)) > err_bound1) && (fabsf(*((float*)tmp_col + 0)) > err_bound1)) * (*((float*)tmp_col + 0));
        res[25] += int( (fabsf(*((float*)tmp_row + 3)) > err_bound1) && (fabsf(*((float*)tmp_col + 1)) > err_bound1)) * (*((float*)tmp_col + 1));
        res[26] += int( (fabsf(*((float*)tmp_row + 3)) > err_bound1) && (fabsf(*((float*)tmp_col + 2)) > err_bound1)) * (*((float*)tmp_col + 2));
        res[27] += int( (fabsf(*((float*)tmp_row + 3)) > err_bound1) && (fabsf(*((float*)tmp_col + 3)) > err_bound1)) * (*((float*)tmp_col + 3));
        res[28] += int( (fabsf(*((float*)tmp_row + 3)) > err_bound1) && (fabsf(*((float*)tmp_col + 4)) > err_bound1)) * (*((float*)tmp_col + 4));
        res[29] += int( (fabsf(*((float*)tmp_row + 3)) > err_bound1) && (fabsf(*((float*)tmp_col + 5)) > err_bound1)) * (*((float*)tmp_col + 5));
        res[30] += int( (fabsf(*((float*)tmp_row + 3)) > err_bound1) && (fabsf(*((float*)tmp_col + 6)) > err_bound1)) * (*((float*)tmp_col + 6));
        res[31] += int( (fabsf(*((float*)tmp_row + 3)) > err_bound1) && (fabsf(*((float*)tmp_col + 7)) > err_bound1)) * (*((float*)tmp_col + 7));
        __syncthreads();
        }
    ...
    C_res[4 ] = *((float4 *)(C+ M * 4) + 0 );
    C_res[5 ] = *((float4 *)(C+ M * 5) + 0 );
    C_res[6 ] = *((float4 *)(C+ M * 6) + 0 );
    C_res[7 ] = *((float4 *)(C+ M * 7) + 0 );
    ...
    C_res[1].y = alpha * res[9  ] + beta * C_res[1].y;
    C_res[1].z = alpha * res[17 ] + beta * C_res[1].z;
    C_res[1].w = alpha * res[25 ] + beta * C_res[1].w;
    
    C_res[2].x = alpha * res[2  ] + beta * C_res[2].x;
    C_res[2].y = alpha * res[10 ] + beta * C_res[2].y;
    C_res[2].z = alpha * res[18 ] + beta * C_res[2].z;
    C_res[2].w = alpha * res[26 ] + beta * C_res[2].w;
    
    C_res[3].x = alpha * res[3  ] + beta * C_res[3].x;
    C_res[3].y = alpha * res[11 ] + beta * C_res[3].y;
    C_res[3].z = alpha * res[19 ] + beta * C_res[3].z;
    C_res[3].w = alpha * res[27 ] + beta * C_res[3].w;
    
    C_res[4].x = alpha * res[4  ] + beta * C_res[4].x;
    C_res[4].y = alpha * res[12 ] + beta * C_res[4].y;
    C_res[4].z = alpha * res[20 ] + beta * C_res[4].z;
    C_res[4].w = alpha * res[28 ] + beta * C_res[4].w;
    
    C_res[5].x = alpha * res[5  ] + beta * C_res[5].x;
    C_res[5].y = alpha * res[13 ] + beta * C_res[5].y;
    C_res[5].z = alpha * res[21 ] + beta * C_res[5].z;
    C_res[5].w = alpha * res[29 ] + beta * C_res[5].w;
    
    C_res[6].x = alpha * res[6  ] + beta * C_res[6].x;
    C_res[6].y = alpha * res[14 ] + beta * C_res[6].y;
    C_res[6].z = alpha * res[22 ] + beta * C_res[6].z;
    C_res[6].w = alpha * res[30 ] + beta * C_res[6].w;
    
    C_res[7].x = alpha * res[7  ] + beta * C_res[7].x;
    C_res[7].y = alpha * res[15 ] + beta * C_res[7].y;
    C_res[7].z = alpha * res[23 ] + beta * C_res[7].z;
    ...
    *((float4 *)(C+ M * 4) + 0 ) = C_res[4 ];
    *((float4 *)(C+ M * 5) + 0 ) = C_res[5 ];
    *((float4 *)(C+ M * 6) + 0 ) = C_res[6 ];
    *((float4 *)(C+ M * 7) + 0 ) = C_res[7 ];
